...
export default function FloatingCTA() {
  ...
  const phoneUrl = "tel:+917019000191";
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3.5">
      ...
      <a
        href={phoneUrl}
        aria-label="Call Artist"
        className="flex items-center justify-center w-14 h-14 bg-neutral-dark text-gold-primary border border-gold-primary/30 rounded-full shadow-[0_8px_30px_rgba(0,0,0,0.3)] hover:bg-gold-primary hover:text-neutral-dark hover:border-gold-primary transition-smooth cursor-pointer"
      >
      ...
      <a
        ...
        className="flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.3)] hover:bg-[#20ba5a] transition-smooth cursor-pointer"
      >
        <svg
          viewBox="0 0 24 24"
